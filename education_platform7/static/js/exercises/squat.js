export const squat = {
    ...
    analyze(lm, state, showHint, logError, calcAngle) {
        ...
        if (knee < this.thresholds.kneeAngleDown && state.position === 'up') {
            ...
            showHint('Готов к следующему приседу', this.svgIcons.bodyDown, 'rgba(16, 185, 129, 0.95)', 1500);
            result.status = 'Готов';
